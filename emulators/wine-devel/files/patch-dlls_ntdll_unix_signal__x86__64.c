...
+++ dlls/ntdll/unix/signal_x86_64.c	2024-01-28 19:36:26.807058000 +0300
@@ -18,6 +18,8 @@
...
+
 ...
 #pragma makedep unix
 #endif
@@ -144,6 +146,7 @@ __ASM_GLOBAL_FUNC( alloc_fs_sel,
...
+#if defined(__linux__) || defined(__FreeBSD__)
 ...
 {
     unsigned long rsp;
@@ -825,6 +828,17 @@ static inline ucontext_t *init_handler( void *sigconte
...
+#ifdef USE_FS
+        USHORT sel = GSEL(GUFS32_SEL, SEL_UPL);
...
@@ -834,7 +848,7 @@ static inline ucontext_t *init_handler( void *sigconte
  */
...
+#if defined(__linux__) || defined(__FreeBSD__)
 ...
 #endif
@@ -1598,7 +1612,7 @@ __ASM_GLOBAL_FUNC( call_user_mode_callback,
...
@@ -2174,6 +2188,7 @@ static void usr1_handler( int signal, siginfo_t *sigin
  *           LDT support
  */
...
@@ -2231,6 +2246,16 @@ static void ldt_set_entry( WORD sel, LDT_ENTRY entry )
...
+    }
     ...
     exit(1);
@@ -2299,6 +2324,7 @@ NTSTATUS signal_alloc_thread( TEB *teb )
...
@@ -2378,7 +2404,6 @@ static void *mac_thread_gsbase(void)
 }
 #endif
...
-
  ...
  *		signal_init_process
  */
@@ -2414,7 +2439,7 @@ void signal_init_process(void)
         }
...
@@ -2438,6 +2463,10 @@ void signal_init_process(void)
...
@@ -2484,8 +2513,9 @@ void call_init_thunk( LPTHREAD_START_ROUTINE entry, vo
...
+    amd64_get_fsbase(&thread_data->pthread_teb);
 ...
 #elif defined (__APPLE__)
@@ -2588,7 +2618,6 @@ __ASM_GLOBAL_FUNC( signal_start_thread,
                    "1:\tmovq %r8,%rsp\n\t"
...
-
  ...
  */
@@ -2632,7 +2661,11 @@ __ASM_GLOBAL_FUNC( __wine_syscall_dispatcher,
...
+#endif
                    ...
                    "jz 2f\n\t"
@@ -2696,6 +2729,26 @@ __ASM_GLOBAL_FUNC( __wine_syscall_dispatcher,
                    "leaq -0x98(%rbp),%rcx\n"
                    "2:\n\t"
 #endif
+#ifdef __FreeBSD__
...
+#endif
                    ...
                    "movq 0x18(%rcx),%r11\n\t"      /* 2nd argument */
                    "movl %eax,%ebx\n\t"
@@ -2768,7 +2821,7 @@ __ASM_GLOBAL_FUNC( __wine_syscall_dispatcher,
                    "movq 0x20(%rcx),%rsi\n\t"
                    "movq 0x08(%rcx),%rbx\n\t"
...
+#if defined(__linux__) || defined(__FreeBSD__)
                    ...
                    "jz 1f\n\t"
                    "movw %gs:0x338,%fs\n"          /* amd64_thread_data()->fs */
@@ -2902,6 +2955,22 @@ __ASM_GLOBAL_FUNC( __wine_unix_call_dispatcher,
                    "syscall\n\t"
                    "2:\n\t"
 #endif
+#ifdef __FreeBSD__
...
+#endif
                    ...
                    "callq *(%r10,%rdx,8)\n\t"
                    "movq %rsp,%rcx\n\t"
@@ -2920,7 +2989,7 @@ __ASM_GLOBAL_FUNC( __wine_unix_call_dispatcher,
                    /* switch to user stack */
                    "movq 0x88(%rcx),%rsp\n\t"
